...
function ssstik(url) {
  return new Promise((resolve, reject) => {
    ...
    Axios.request({
      ...
      headers: {
        cookie:
          "__cfduid=deb9cec7a40793d1abe009bb9961a92d41617497572; PHPSESSID=7ivsp9hc6askg1qocpi8lfpn7n; __cflb=02DiuEcwseaiqqyPC5q2cQqNGembhyZ5QaychuqFzev83; _ga=GA1.2.131585469.1617497575; _gid=GA1.2.1629908100.1617497575; _gat_UA-3524196-6=1",
        "user-agent":
      ...
      .then(({ data }) => {
        ...
        const urlPost = $('form[data-hx-target="#target"]').attr(
          "data-hx-post"
        );
        const tokenJSON = $('form[data-hx-target="#target"]').attr(
          "include-vals"
        );
        ...
        Axios.post(BASEurl + urlPost, qs.stringify(config.dataPost), {
          ...
          .then(({ data }) => {
            ...
            if (
              $("div > a.without_watermark_direct").attr("href") !== undefined
            ) {
              resolve(result);
            } else {
              reject({
  ...
  return new Promise((resolve, reject) => {
    Axios.get("https://musicallydown.com", {
      headers: {
        ...
        cookie:
          "__cfduid=d1a03c762459f64f87734977f474142fe1618464905; session_data=ac6a59adeffddbf12d71d4d9e368fee9; _ga=GA1.2.1692872429.1618464910; _gid=GA1.2.371863113.1618464910; __atuvc=2%7C15; __atuvs=6077d08d902cbf1a001; __atssc=google%3B2",
      },
    }).then(({ data }) => {
      // return console.log(data)
      const $ = cheerio.load(data);
      ...
      Axios({
        ...
        const result = {
          ...
          preview: $(
            "div.row > div > h1.cushead.white-text > video#video"
          ).attr("poster"),
...
function keeptiktok(url) {
  return new Promise((resolve, reject) => {
    Axios.get("https://keeptiktok.com/?lang=ID", {
      headers: {
        Cookie:
          "__cfduid=d5db462e7efb9bb76bcf89765dbd896c91617891082; PHPSESSID=5a017bebc34ef170ddec3b7c71a0bbe8; _ga=GA1.2.1193000489.1617891094; _gid=GA1.2.408908588.1617891094; ads=ok; __atuvc=3|14; __atuvs=606f0f171d8ce8a1002; __atssc=google;2",
      },
    }).then(({ data }) => {
      const $ = cheerio.load(data);
